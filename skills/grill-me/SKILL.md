---
name: grill-me
description: Interviews the user relentlessly about a plan or design until reaching shared understanding, resolving each branch of the decision tree. Runs three automatic grill passes, then surfaces the emergent questions as one batch for the user to decide (recommended answer + alternatives + add-your-own + dispute), then one informed pass. Use when user wants to stress-test a plan, get grilled on their design, or mentions "grill me".
---
